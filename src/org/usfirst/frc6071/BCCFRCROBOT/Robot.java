...
public class Robot extends IterativeRobot {
   ...
   Command autonomousCommand;
    ...
    public static ClawGrip clawGrip;
    Timer myTimer;
    boolean driveDone;
	...
	driveDone = false;
    	...
    	// org.usfirst.frc6071.BCCFRCROBOT.subsystems.autonDrive.drive(0.3);
    ...
    public void autonomousPeriodic() {
        ...
        if (autonomousCommand != null) autonomousCommand.start();
    	 //if (autonType == 0) {
    	/*
    	    	System.out.println("Auton 0: Straight Line Running!");

    	    	if (myTimer.get() >= 2) {
    	    		System.out.println("Auto Stop Fuction Running");
    	    		frontLeft.set(0.0001);
    	    		frontRight.set(0.0001);
    	    		backLeft.set(0.0001);
    	    		backRight.set(0.0001);
    	    		driveDone = true ;
    	    	}
    	    	else if (myTimer.get() < 2 && driveDone == false ){
    	    		
    	    		System.out.println(myTimer.get());
    	    		// org.usfirst.frc6071.BCCFRCROBOT.subsystems.autonDrive.drive(0.09);
    	       		frontLeft.set(0.09);
    	    		frontRight.set(0.09);
    	    		backLeft.set(0.09);
    	    		backRight.set(0.09);
